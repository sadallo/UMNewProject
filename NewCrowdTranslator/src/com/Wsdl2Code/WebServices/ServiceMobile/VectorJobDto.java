...
public class VectorJobDto extends Vector<JobDto> implements KvmSerializable, Serializable {
    
    
    public VectorJobDto(){}
    
    public VectorJobDto(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
