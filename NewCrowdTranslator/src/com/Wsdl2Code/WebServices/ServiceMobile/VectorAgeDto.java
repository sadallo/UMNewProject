...
public class VectorAgeDto extends Vector<AgeDto> implements KvmSerializable, Serializable {
    
    
    public VectorAgeDto(){}
    
    public VectorAgeDto(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
